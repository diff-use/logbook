...
Saved images every 30˚ at zoom 4.
...
Saved images every 30˚ again for reference (zoom 4).
...
Snapped images every 30˚ again for reference (zoom 4).
...
Snapped images every 30˚ using the on-axis camera at 4x zoom.
...
Images saved every 30˚. Cryostream at 295 K. 
...
Snapped images every 30˚ using the on-axis camera at 1x zoom showing the entire loop, and at each crystal position at 4x zoom.
